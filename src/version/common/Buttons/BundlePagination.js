        ...
        return (
            <div className={classes.paginatorRoot}>
                <Tooltip title="First page">
                    <IconButton onClick={() => this.pageSelected(page - 1)} className={classes.button} disabled={page === 1} aria-label="First page">
                        <FirstPageIcon />
                    </IconButton>
                </Tooltip>
                <Tooltip title="Previous page">
                    <IconButton onClick={() => this.pageSelected(page - 1)} className={classes.button} disabled={page === 1} aria-label="Previous page">
                        <KeyboardArrowLeft />
                    </IconButton>
                </Tooltip>
                { buttons }
                <Tooltip title="Next page">
                    <IconButton onClick={() => this.pageSelected(page + 1)} className={classes.button} disabled={page === buttonsNumber} aria-label="Next page">
                        <KeyboardArrowRight />
                    </IconButton>
                </Tooltip>
                <Tooltip title="Last page">
                    <IconButton onClick={() => this.pageSelected(buttonsNumber)} className={classes.button} disabled={page === buttonsNumber} aria-label="Last page">
                       <LastPageIcon />
                    </IconButton>
                </Tooltip>
            </div>
